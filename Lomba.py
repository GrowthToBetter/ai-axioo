...
class EnhancedEmergencyNLPSystem:
    ...
    def process_facebook_message_streaming(self, from_number, message_body, message_id, message_type, media_url=None):
        ...
        try:
            ...
            # Generate and send response with enhanced formatting using existing functions
            self.generate_and_send_enhanced_response(
    ...
    def generate_and_send_enhanced_response(self, from_number, extracted_info, message_body, 
        ...
        try:
            ...
            try:
                fallback_response = self.generate_optimized_emergency_response(
                    extracted_info, message_body, report_id, from_number
                )
                self.send_whatsapp_message_fast(from_number, fallback_response)
            except:
                self.send_whatsapp_message_fast(
                    from_number,
